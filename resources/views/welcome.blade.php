...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            <h1 class="logo me-auto"><a href="index.html">L-PERAN</a></h1>
                            ...
                            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block ">
                                @auth
                                    <a href="{{ url('/dashboard') }}"
                                        class="nav-link scrollto getstarted text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}"
                                        class="nav-link scrollto getstarted text-sm text-gray-700 dark:text-gray-500 underline">Log
                                        in</a>

                                    {{-- @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="nav-link scrollto getstarted ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a>
                        @endif --}}
                                @endauth
                            </div>
                        @endif</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>L-PERAN</h1>
                    <h2>Lembaga Pemerdayaan Rakyat Nusantara</h2>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="assets/img/logo-lperan.png  " class="img-fluid animated" alt="" />
                </div>
            </div>
        </div>
    </section>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#37517e" fill-opacity="12"
            d="M0,64L48,101.3C96,139,192,213,288,213.3C384,213,480,139,576,106.7C672,75,768,85,864,106.7C960,128,1056,160,1152,165.3C1248,171,1344,149,1392,138.7L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z">
        </path>
    </svg>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>
                            Cikal bakal Lembaga Kebijakan Pengadaan Barang/Jasa Pemerintah bermula dari sebuah unit
                            kerja bernama Pusat Pengembangan Kebijakan Pengadaan Barang/Jasa Publik (PPKPBJ)sebagai unit
                            kerja eselon II. Dibentuk pada tahun 2005,
                            unit kerja ini bertugas menyusun kebijakan dan regulasi pengadaan barang/jasa pemerintah,
                            memberikan bimbingan teknis dan advokasi terkait pelaksanaan pengadaan barang/jasa
                            pemerintah, serta memfasilitasi penyelenggaraan
                            ujian sertifikasi ahli pengadaan barang/jasa pemerintah.
                        </p>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>
                            Di samping melaksanakan program sesuai visi-misi, tujuan dan sasaran strategis, LKPP juga
                            bertanggungjawab untuk mencapai sasaran-sasaran nasional seperti diamanatkan dalam RPJMN
                            2010-2014, dengan prioritas di bidang
                            aparatur pemerintahan yang baik, peningkatan penyelenggaraan pemerintahan yang bersih, bebas
                            korupsi, kolusi dan nepotisme. Secara spesifik, fungsi dan kewenangan lembaga ini adalah
                            penyelenggaraan tata kelola pemerintahan
                            yang baik dalam pengadaan barang/jasa pemerintah.
                        </p>
                    </div>
                </div>
            </div>
